...
public class ItemObjectFactory : Singleton<ItemObjectFactory>
{
    ...
    public void RequestCreateOneType(Vector3 position, string _objType)
    {
            CreateOneType(position, _objType);
       // else
       // {
       //     photonView.RPC(nameof(CreateOneType), RpcTarget.MasterClient, position,_objType);
       // }
    }
